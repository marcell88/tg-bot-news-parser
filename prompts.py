...
Шкала:
- 0 баллов — Нет эмоций: Сухие факты, статистика, бюрократические решения
- 2 балла — Слабая эмоция: Едва заметный оттеклик, но без яркости
- 4 балла — Умеренная эмоция: Чувства есть, но они предсказуемы
- 6 баллов — Яркая эмоция: Вызывает смех, удивление, лёгкое возмущение или умиление
...
Шкала:
- 0 баллов — Нет образов: Абстрактные данные, цифры, декларации
- 2 балла — Слабый образ: Есть объект, но он скучный
- 4 балла — Общепринятый символ: Узнаваемый, но без деталей
- 6 баллов — Яркая деталь: Запоминающаяся сцена
- 8 баллов — Кинематографичность: Готовый эпизод для комедии
- 10 баллов — Шедевр абсурда: Образ настолько силён, что становится мемом

3. ИНТЕРЕСНОСТЬ ГЕРОЕВ
Оцени, насколько герои новости могут быть интересны читателю:

Шкала:
- 0 баллов — Совершенно неинтересен: Анонимный источник или случайный человек
- 2 балла — Слегка интересен: Обычный человек в немного необычной ситуации
- 4 балла — Умеренно интересен: Эксперт или местная знаменитость с узкой известностью
- 6 баллов — Достаточно интересен: Известный герой или необычная история
- 8 баллов — Очень интересен: Медийная персона с интересной историей
- 10 баллов — Максимально интересен: Персона, чьи действия/слова могут повлиять на многих

4. АКТУАЛЬНОСТЬ
Оцени, насколько новость актуальна для среднего жителя России:

Шкала:
- 0 баллов — Совершенно неактуально: Не представляет интереса для современной аудитории
...
- 6 баллов — Значительная актуальность: Затрагивает важные социальные темы
- 8 баллов — Высокая актуальность: Отражает ключевые проблемы общества
- 10 баллов — Максимальная актуальность: Событие, определяющее современную повестку

5. ДРАМАТИЧНОСТЬ
Оцени степень драмы в новости:

Шкала:
- 0 баллов — Нет драмы: Сухие факты, рутина
- 2 балла — Слабая драма: Минимальный конфликт
- 4 балла — Умеренная драма: Заметное противостояние или трудности
...
- 10 баллов — Граница допустимого: Почти трагедия, но без необратимых последствий
...
```json
{
  "essence_score": 7.2,
  "essence_max": 8,
  "essence_explain": "Эмоциональность: 8/10 (новость вызывает живой интерес), Визуальность: 6/10 (есть запоминающиеся детали), Герои: 7/10 (интересные персонажи), Актуальность: 8/10 (затрагивает важные темы), Драматичность: 7/10 (есть конфликт). Общая оценка отражает хороший потенциал новости."
}
