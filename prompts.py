...
Алгоритм действий:
1) Найди один яркий образ. Проанализируй суть новости. Создай яркую, точную метафору, которая передает атмосферу или главный конфликт события.
...
6) Если сам оригинальный текст короткий - то можно взять его как есть.
