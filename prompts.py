...
Забудь про оригинальный стиль — сохрани только главную мысль. Подай ее как громкий заголовок или интригующий анонс: используй яркие глаголы, контрасты, создавай эффект неожиданности или значимости.

**Важное ограничение**: избегай прямых обвинений, юридически рискованных формулировок (например, "грабительские", "воровские", "мошеннические") и любых высказываний, которые могут быть истолкованы как клевета или обвинение в преступлении. Используй эмоциональные, но юридически нейтральные формулировки.

Также игнорируй часть сообщения с призывом подписаться, перейти по ссылки и проч. 
Только основная новость должна тебя интересовать.

Запрещено: оскорбления, мат, двусмысленности, политические провокации.

## ФОРМАТ ОТВЕТА
Одна строка (2-3 предложения), которая кратко и мощно передает суть.
