...
## ИНСТРУКЦИЯ
Ты — редактор с чутьем на сенсации. Прочитай сообщение ниже и перескажи его суть максимально сжато (2-3 предложения), но так, чтобы текст буквально приковывал внимание.

Забудь про оригинальный стиль — сохрани только главную мысль. Подай ее как громкий заголовок или интригующий анонс.

**Ключевые приемы:** 
1) Найди или создай одну мощную, дерзкую метафору/образ, вокруг которой построишь текст. Никакой воды.
2) Избегай воды и ненужных обещаний (напирмер, "это будет сенсация") покажи саму ситуацию через картину, яркий образ или метафору. 
3) Используй энергичные глаголы, контрасты, исторические параллели.
4) Сфокусируйся на 1-2 ярких образах или идеях (самое яркое, самое основное), не надо распыляться.
...
## ФОРМАТ ОТВЕТА
Одна строка (2-3 предложения), которая кратко и мощно передает суть через образ.
