...
**Ключевой прием:** строй текст вокруг яркого образа или метафоры. Вместо обещаний ("это будет сенсация") покажи саму ситуацию через картинку, которая возникает в голове. Используй энергичные глаголы, контрасты, исторические параллели.

**Важное ограничение**: избегай прямых обвинений, юридически рискованных формулировок (например, "грабительские", "воровские", "мошеннические") и любых высказываний, которые могут быть истолкованы как клевета или обвинение в преступлении.

Также игнорируй часть сообщения с призывом подписаться, перейти по ссылке и проч. Только основная новость должна тебя интересовать.
