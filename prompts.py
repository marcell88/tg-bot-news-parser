...
2. Рекламные и маркетинговые материалы, откровенный пиар товаров, услуг, персон.
3. Дайджесты новостей - сводки из нескольких разнородных новостей без единой темы.

===
ВАЖНЫЕ ИСКЛЮЧЕНИЯ
Не отклоняй новости даже если они формально относятся к запретным темам, если данная запретная упоминается в более широком контексте и не является основной темой новости. Например, статистика и аналитические материалы, общие дискуссии о разных общественных проблемах, обсуждение законов и политики, и прочее.
...
3.  Посмотри внимательно на "ВАЖНОЕ ИСКЛЮЧЕНИЕ" - применимо ли оно ("запретная упоминается в более широком контексте и не является основной темой новости").
4.  Сформируй ответ:
    - Если новость подпадает под критерии фильтрации (отклонения) и НЕ подпадает под важное исключение, то:
        filter - false
        explain - 1-2 предложения, укажи номер или суть нарушенного пункта (например: "П.6 Доп.критериев: сообщение-ссылка")
    - Если новость НЕ подпадает под критерии фильтрации (отклонения), или если подпадает под важное исключение, то:
        filter - true
